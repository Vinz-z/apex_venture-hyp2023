<template>
    <Banner
        imageUrl="/images/banners/collage.png"
        title="Areas"
...
.sectors {
  display: grid;
  grid-template-columns: 1fr; /* Specify one column */
  row-gap: 25px; /* Define the fixed spacing between grid rows */
  align-self: start; /* Center align the items horizontally */
}
