<template>
  ...
  >
    ...
    <data-grid
      :dataTopLeft="project_statistics[0].value"
      :captionTopLeft="project_statistics[0].caption"
      :dataTopRight="project_statistics[1].value"
      :captionTopRight="project_statistics[1].caption"
      :dataBottomLeft="project_statistics[2].value"
      :captionBottomLeft="project_statistics[2].caption"
    ...
    <div class="desktop:col-span-2">
      <div class="grid grid-cols-9 h-80 place-content-center">
        <div
          class="col-span-4 bg-red flex flex-row"
          :style="`background-image: url(\'${previous.banner}\');`"
        >
        ...
        <div
          class="col-span-4 bg-blue"
          :style="`background-image: url(\'${next.banner}\');`"
        >
          <div>a</div>
          <div>{{ next.name }}</div>
          <div>a</div>
